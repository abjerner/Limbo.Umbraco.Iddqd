angular.module("umbraco").directive("limboIddqdJsonView", function () {
    ...
    return {
        ...
        template: "<div class=\"limbo-iddqd-json-view\"><umb-button type=\"button\" state=\"copyButtonState\" ng-click=\"copy()\" label=\"Copy\"></umb-button></div>",
